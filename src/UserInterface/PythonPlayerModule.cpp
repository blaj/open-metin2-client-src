...
void initPlayer()
{
    ...
    PyModule_AddIntConstant(poModule, "NONE",                           POINT_NONE);
	...
	PyModule_AddIntConstant(poModule, "MAGIC_ATT_GRADE",                POINT_MAGIC_ATT_GRADE);
	PyModule_AddIntConstant(poModule, "MAGIC_DEF_GRADE",                POINT_MAGIC_DEF_GRADE);
	PyModule_AddIntConstant(poModule, "EMPIRE_POINT",                   POINT_EMPIRE_POINT);
	PyModule_AddIntConstant(poModule, "LEVEL_STEP",                     POINT_LEVEL_STEP);
	PyModule_AddIntConstant(poModule, "STAT",                           POINT_STAT);
	PyModule_AddIntConstant(poModule, "SUB_SKILL",						POINT_SUB_SKILL);
	PyModule_AddIntConstant(poModule, "SKILL_ACTIVE",                   POINT_SKILL);
	PyModule_AddIntConstant(poModule, "MIN_ATK",                        POINT_MIN_ATK);
	PyModule_AddIntConstant(poModule, "MAX_ATK",                        POINT_MAX_ATK);
	PyModule_AddIntConstant(poModule, "PLAYTIME",                       POINT_PLAYTIME);
	PyModule_AddIntConstant(poModule, "HP_REGEN",                       POINT_HP_REGEN);
	PyModule_AddIntConstant(poModule, "SP_REGEN",                       POINT_SP_REGEN);
	...
	PyModule_AddIntConstant(poModule, "POISON_PCT",                     POINT_POISON_PCT);
	PyModule_AddIntConstant(poModule, "STUN_PCT",                       POINT_STUN_PCT);
	PyModule_AddIntConstant(poModule, "SLOW_PCT",                       POINT_SLOW_PCT);
	PyModule_AddIntConstant(poModule, "CRITICAL_PCT",                   POINT_CRITICAL_PCT);
	PyModule_AddIntConstant(poModule, "PENETRATE_PCT",                  POINT_PENETRATE_PCT);
	PyModule_AddIntConstant(poModule, "CURSE_PCT",                      POINT_CURSE_PCT);
	PyModule_AddIntConstant(poModule, "ATTBONUS_HUMAN",                 POINT_ATTBONUS_HUMAN);
	PyModule_AddIntConstant(poModule, "ATTBONUS_ANIMAL",                POINT_ATTBONUS_ANIMAL);
	PyModule_AddIntConstant(poModule, "ATTBONUS_ORC",                   POINT_ATTBONUS_ORC);
	PyModule_AddIntConstant(poModule, "ATTBONUS_MILGYO",                POINT_ATTBONUS_MILGYO);
	PyModule_AddIntConstant(poModule, "ATTBONUS_UNDEAD",                POINT_ATTBONUS_UNDEAD);
	PyModule_AddIntConstant(poModule, "ATTBONUS_DEVIL",                 POINT_ATTBONUS_DEVIL);
	PyModule_AddIntConstant(poModule, "ATTBONUS_INSECT",                POINT_ATTBONUS_INSECT);
	PyModule_AddIntConstant(poModule, "ATTBONUS_FIRE",                  POINT_ATTBONUS_FIRE);
	PyModule_AddIntConstant(poModule, "ATTBONUS_ICE",                   POINT_ATTBONUS_ICE);
	PyModule_AddIntConstant(poModule, "ATTBONUS_DESERT",                POINT_ATTBONUS_DESERT);
	PyModule_AddIntConstant(poModule, "ATTBONUS_MONSTER",				POINT_ATTBONUS_MONSTER);
	PyModule_AddIntConstant(poModule, "ATTBONUS_WARRIOR",				POINT_ATTBONUS_WARRIOR);
	PyModule_AddIntConstant(poModule, "ATTBONUS_ASSASSIN",				POINT_ATTBONUS_ASSASSIN);
	PyModule_AddIntConstant(poModule, "ATTBONUS_SURA",					POINT_ATTBONUS_SURA);
	PyModule_AddIntConstant(poModule, "ATTBONUS_SHAMAN",				POINT_ATTBONUS_SHAMAN);
	PyModule_AddIntConstant(poModule, "ATTBONUS_TREE",					POINT_ATTBONUS_TREE);
	PyModule_AddIntConstant(poModule, "RESIST_WARRIOR",					POINT_RESIST_WARRIOR);
	PyModule_AddIntConstant(poModule, "RESIST_ASSASSIN",				POINT_RESIST_ASSASSIN);
	PyModule_AddIntConstant(poModule, "RESIST_SURA",					POINT_RESIST_SURA);
	PyModule_AddIntConstant(poModule, "RESIST_SHAMAN",					POINT_RESIST_SHAMAN);
	PyModule_AddIntConstant(poModule, "STEAL_HP",                       POINT_STEAL_HP);
	PyModule_AddIntConstant(poModule, "STEAL_SP",                       POINT_STEAL_SP);
	PyModule_AddIntConstant(poModule, "MANA_BURN_PCT",                  POINT_MANA_BURN_PCT);
	PyModule_AddIntConstant(poModule, "DAMAGE_SP_RECOVER",              POINT_DAMAGE_SP_RECOVER);
	PyModule_AddIntConstant(poModule, "BLOCK",                          POINT_BLOCK);
	PyModule_AddIntConstant(poModule, "DODGE",                          POINT_DODGE);
	PyModule_AddIntConstant(poModule, "RESIST_SWORD",                   POINT_RESIST_SWORD);
	PyModule_AddIntConstant(poModule, "RESIST_TWOHAND",                 POINT_RESIST_TWOHAND);
	PyModule_AddIntConstant(poModule, "RESIST_DAGGER",                  POINT_RESIST_DAGGER);
	PyModule_AddIntConstant(poModule, "RESIST_BELL",                    POINT_RESIST_BELL);
	PyModule_AddIntConstant(poModule, "RESIST_FAN",                     POINT_RESIST_FAN);
	PyModule_AddIntConstant(poModule, "RESIST_BOW",                     POINT_RESIST_BOW);
	PyModule_AddIntConstant(poModule, "RESIST_FIRE",                    POINT_RESIST_FIRE);
	PyModule_AddIntConstant(poModule, "RESIST_ELEC",                    POINT_RESIST_ELEC);
	PyModule_AddIntConstant(poModule, "RESIST_MAGIC",                   POINT_RESIST_MAGIC);
	PyModule_AddIntConstant(poModule, "RESIST_WIND",                    POINT_RESIST_WIND);
	PyModule_AddIntConstant(poModule, "REFLECT_MELEE",                  POINT_REFLECT_MELEE);
	PyModule_AddIntConstant(poModule, "REFLECT_CURSE",                  POINT_REFLECT_CURSE);
	PyModule_AddIntConstant(poModule, "POISON_REDUCE",                  POINT_POISON_REDUCE);
	PyModule_AddIntConstant(poModule, "KILL_SP_RECOVER",                POINT_KILL_SP_RECOVER);
	PyModule_AddIntConstant(poModule, "EXP_DOUBLE_BONUS",               POINT_EXP_DOUBLE_BONUS);
	PyModule_AddIntConstant(poModule, "GOLD_DOUBLE_BONUS",              POINT_GOLD_DOUBLE_BONUS);
	PyModule_AddIntConstant(poModule, "ITEM_DROP_BONUS",                POINT_ITEM_DROP_BONUS);
	PyModule_AddIntConstant(poModule, "POTION_BONUS",                   POINT_POTION_BONUS);
	PyModule_AddIntConstant(poModule, "KILL_HP_RECOVER",                POINT_KILL_HP_RECOVER);
	PyModule_AddIntConstant(poModule, "IMMUNE_STUN",                    POINT_IMMUNE_STUN);
	PyModule_AddIntConstant(poModule, "IMMUNE_SLOW",                    POINT_IMMUNE_SLOW);
	PyModule_AddIntConstant(poModule, "IMMUNE_FALL",                    POINT_IMMUNE_FALL);
	PyModule_AddIntConstant(poModule, "PARTY_ATT_GRADE",                POINT_PARTY_ATT_GRADE);
	PyModule_AddIntConstant(poModule, "PARTY_DEF_GRADE",                POINT_PARTY_DEF_GRADE);
	PyModule_AddIntConstant(poModule, "ATT_BONUS",						POINT_ATT_BONUS);
	PyModule_AddIntConstant(poModule, "DEF_BONUS",						POINT_DEF_BONUS);
	PyModule_AddIntConstant(poModule, "ATT_GRADE_BONUS",                POINT_ATT_GRADE_BONUS);
	PyModule_AddIntConstant(poModule, "DEF_GRADE_BONUS",                POINT_DEF_GRADE_BONUS);
	PyModule_AddIntConstant(poModule, "MAGIC_ATT_GRADE_BONUS",          POINT_MAGIC_ATT_GRADE_BONUS);
	PyModule_AddIntConstant(poModule, "MAGIC_DEF_GRADE_BONUS",          POINT_MAGIC_DEF_GRADE_BONUS);
	PyModule_AddIntConstant(poModule, "RESIST_NORMAL_DAMAGE",           POINT_RESIST_NORMAL_DAMAGE);
	PyModule_AddIntConstant(poModule, "HIT_HP_RECOVERY",                POINT_HIT_HP_RECOVERY);
	PyModule_AddIntConstant(poModule, "HIT_SP_RECOVERY",                POINT_HIT_SP_RECOVERY);
	PyModule_AddIntConstant(poModule, "MANASHIELD",                     POINT_MANASHIELD);
	PyModule_AddIntConstant(poModule, "PARTY_BUFFER_BONUS",             POINT_PARTY_BUFFER_BONUS);
	PyModule_AddIntConstant(poModule, "PARTY_SKILL_MASTER_BONUS",       POINT_PARTY_SKILL_MASTER_BONUS);
	PyModule_AddIntConstant(poModule, "HP_RECOVER_CONTINUE",            POINT_HP_RECOVER_CONTINUE);
	PyModule_AddIntConstant(poModule, "SP_RECOVER_CONTINUE",            POINT_SP_RECOVER_CONTINUE);
	PyModule_AddIntConstant(poModule, "STEAL_GOLD",                     POINT_STEAL_GOLD);
	PyModule_AddIntConstant(poModule, "POLYMORPH",                      POINT_POLYMORPH);
	PyModule_AddIntConstant(poModule, "MOUNT",                          POINT_MOUNT);
	PyModule_AddIntConstant(poModule, "PARTY_HASTE_BONUS",              POINT_PARTY_HASTE_BONUS);
	PyModule_AddIntConstant(poModule, "PARTY_DEFENDER_BONUS",           POINT_PARTY_DEFENDER_BONUS);
	PyModule_AddIntConstant(poModule, "STAT_RESET_COUNT",               POINT_STAT_RESET_COUNT);
	PyModule_AddIntConstant(poModule, "HORSE_SKILL",                    POINT_HORSE_SKILL);
	PyModule_AddIntConstant(poModule, "MALL_ATTBONUS",                  POINT_MALL_ATTBONUS);
	PyModule_AddIntConstant(poModule, "MALL_DEFBONUS",                  POINT_MALL_DEFBONUS);
	PyModule_AddIntConstant(poModule, "MALL_EXPBONUS",                  POINT_MALL_EXPBONUS);
	PyModule_AddIntConstant(poModule, "MALL_ITEMBONUS",                 POINT_MALL_ITEMBONUS);
	PyModule_AddIntConstant(poModule, "MALL_GOLDBONUS",                 POINT_MALL_GOLDBONUS);
	PyModule_AddIntConstant(poModule, "MAX_HP_PCT",                     POINT_MAX_HP_PCT);
	PyModule_AddIntConstant(poModule, "MAX_SP_PCT",                     POINT_MAX_SP_PCT);
	PyModule_AddIntConstant(poModule, "SKILL_DAMAGE_BONUS",             POINT_SKILL_DAMAGE_BONUS);
	PyModule_AddIntConstant(poModule, "NORMAL_HIT_DAMAGE_BONUS",        POINT_NORMAL_HIT_DAMAGE_BONUS);
	PyModule_AddIntConstant(poModule, "SKILL_DEFEND_BONUS",             POINT_SKILL_DEFEND_BONUS);
	PyModule_AddIntConstant(poModule, "NORMAL_HIT_DEFEND_BONUS",        POINT_NORMAL_HIT_DEFEND_BONUS);
	PyModule_AddIntConstant(poModule, "PC_BANG_EXP_BONUS",              POINT_PC_BANG_EXP_BONUS);
	PyModule_AddIntConstant(poModule, "PC_BANG_DROP_BONUS",             POINT_PC_BANG_DROP_BONUS);
	PyModule_AddIntConstant(poModule, "RAMADAN_CANDY_BONUS_EXP",        POINT_RAMADAN_CANDY_BONUS_EXP);
	...
	PyModule_AddIntConstant(poModule, "COSTUME_ATTR_BONUS",             POINT_COSTUME_ATTR_BONUS);
	PyModule_AddIntConstant(poModule, "MAGIC_ATT_BONUS_PER",            POINT_MAGIC_ATT_BONUS_PER);
	PyModule_AddIntConstant(poModule, "MELEE_MAGIC_ATT_BONUS_PER",      POINT_MELEE_MAGIC_ATT_BONUS_PER);
	PyModule_AddIntConstant(poModule, "RESIST_ICE",                     POINT_RESIST_ICE);
	PyModule_AddIntConstant(poModule, "RESIST_EARTH",                   POINT_RESIST_EARTH);
	...
	PyModule_AddIntConstant(poModule, "HIT_RATE",                       POINT_HIT_RATE);
